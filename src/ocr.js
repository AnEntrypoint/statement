...
- Formula: {"type":"formula","formula":"of:=B2+C2","display":"1 234,56"}
...
- Running balance (balance[n] = balance[n-1] + amount[n]): Seed is a number, each next row is a formula. Balance in col D, amount in col C, row 8: {"type":"formula","formula":"of:=D7+C8","display":"..."}
- Row numbers in formulas must match actual row indices in the JSON output (1 = first rows[] entry)
- Totals: {"type":"formula","formula":"of:=SUM(C2:C15)","display":"..."}
